...
public class PoseConstantsClose {
    ...
    public Pose LAUNCH_POSE = !SharedData.red ? new Pose(56.75,80.75,Math.toRadians(315)) :  new Pose(87.25,80.75,Math.toRadians(225));
    public Pose ALIGN1_POSE = !SharedData.red ? new Pose(45.75,82.75,Math.toRadians(180)) :  new Pose(98.25,82.75,Math.toRadians(0));
    public  Pose PICKUP1_POSE = !SharedData.red ? new Pose(17.75,82.75, Math.toRadians(180)) :  new Pose(126.25,82.75, Math.toRadians(0));
    ...
    public Pose END_POSE = !SharedData.red ? new Pose(45.75,34.75,Math.toRadians(180)) :  new Pose(98.25, 34.75,Math.toRadians(0));
