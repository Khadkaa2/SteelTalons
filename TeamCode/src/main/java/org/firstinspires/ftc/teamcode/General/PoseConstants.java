...
public class PoseConstants {
    ...
    public Pose LAUNCH_POSE = SharedData.side == Side.BLUE ? (SharedData.shootFar ? new Pose(56.75,14.75,Math.toRadians(289)) : new Pose(56.75,80.75,Math.toRadians(312))) :  (SharedData.shootFar ? new Pose(87.25,14.75,Math.toRadians(246)) : new Pose(87.25,80.75,Math.toRadians(225)));
...
//    public static Pose FIELD_OFFSET;
    ...
    public Pose ALIGN3_POSE = SharedData.side == Side.RED ? new Pose(135,28,Math.toRadians(270)) : new Pose(10,28,Math.toRadians(280));
    public Pose PICKUP3_POSE = SharedData.side == Side.RED ? new Pose(135,9,Math.toRadians(270)) : new Pose(10,9,Math.toRadians(280));
}
