...
public class PoseConstants {
    ...
    public static Pose ALIGN1_POSE = new Pose(27,-29,Math.toRadians(90));
    public static Pose PICKUP1_POSE = new Pose(27,-12, Math.toRadians(90));
    public static Pose ALIGN2_POSE = new Pose(51,-29,Math.toRadians(90));
    public static Pose PICKUP2_POSE = new Pose(51, -12, Math.toRadians(90));
    public static Pose END_POSE = new Pose(6,-48,Math.toRadians(150));
